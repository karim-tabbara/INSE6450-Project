...
from inference import measure_single_inference_metrics, measure_batch_inference_metrics, predict_email
import pandas as pd
...
print("(Milestone 3) Model V2 training completed. Metrics:")
print(f"Training completed in {training_time:.4f} milliseconds")
print(f"Iterations used: {iterations_used}")
print(f"Time per iteration: {time_per_iteration * 1000:.4f} milliseconds")
print(f"Memory used during training: {memory_used:.4f} MB")
...
validation_acc, validation_precision_macro, validation_recall_macro, validation_f1_macro, validation_precision_micro, validation_recall_micro, validation_f1_micro, validation_auroc, validation_pr_auc = evaluate_model(modelV2, X_val_final, y_val, dataset_name="Validation")
print("Validation Metrics:")
print(f"Validation Accuracy: {validation_acc:.4f}")
print(f"Validation Precision (Macro): {validation_precision_macro:.4f}")
print(f"Validation Recall (Macro): {validation_recall_macro:.4f}")
...
test_acc, test_precision_macro, test_recall_macro, test_f1_macro, test_precision_micro, test_recall_micro, test_f1_micro, test_auroc, test_pr_auc = evaluate_model(modelV2, X_test_final, y_test, dataset_name="Test")
print("Test Metrics:")
print(f"Test Accuracy: {test_acc:.4f}")
print(f"Test Precision (Macro): {test_precision_macro:.4f}")
print(f"Test Recall (Macro): {test_recall_macro:.4f}")
...
latency_single_p50, latency_single_p90, memory_single_mb = measure_single_inference_metrics(messages, modelV2, vectorizerV2)
print("Single Inference Metrics:")
print(f"Latency (P50): {latency_single_p50:.4f} ms")
print(f"Latency (P90): {latency_single_p90:.4f} ms")
print(f"Memory Usage: {memory_single_mb:.4f} MB")
...
latency_batch_p50, latency_batch_p90, memory_batch_mb, throughput = measure_batch_inference_metrics(messages, modelV2, vectorizerV2)
print("Batch Inference Metrics:")
print(f"Latency (P50): {latency_batch_p50:.4f} ms")
print(f"Latency (P90): {latency_batch_p90:.4f} ms")
print(f"Memory Usage: {memory_batch_mb:.4f} MB")
